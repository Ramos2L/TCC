...
import 'package:tcc_gestao_gado/app/modules/main/manejo/pages/dicas/dicas_manejo_page.dart';
import 'package:tcc_gestao_gado/app/modules/main/manejo/pages/dicas/presenter/dicas_manejo_presenter.dart';
import 'package:tcc_gestao_gado/app/modules/main/manejo/pages/dicas/presenter/dicas_manejo_presenter_impl.dart';
import 'package:tcc_gestao_gado/app/modules/main/manejo/repository/manejo_repository.dart';
import 'package:tcc_gestao_gado/app/modules/main/manejo/repository/manejo_repository_impl.dart';
...
class DicasManejoRoute extends FlutterGetItPageRoute {
  ...
  List<Bind<Object>> get bindings => [
        ...
        Bind.lazySingleton<ManejoRepository>((i) => ManejoRepositoryImpl(
              firebaseFirestore: i(),
            )),
      ];
